---
name: ruflo-agent-collective-intelligence-coordinator
description: Agent skill for collective-intelligence-coordinator - invoke with $ruflo-agent-collective-intelligence-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-collective-intelligence-coordinator, body from .claude/agents/hive-mind/collective-intelligence-coordinator.md). Original name: agent-collective-intelligence-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
