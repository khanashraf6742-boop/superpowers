---
name: ruflo-agent-v3-memory-specialist
description: Agent skill for v3-memory-specialist - invoke with $ruflo-agent-v3-memory-specialist
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-v3-memory-specialist, body from .claude/agents/v3/v3-memory-specialist.md). Original name: agent-v3-memory-specialist. License: MIT. Catalog: docs/incorporated-skills/README.md -->
