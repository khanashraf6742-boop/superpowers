---
name: ruflo-agent-repo-architect
description: Agent skill for repo-architect - invoke with $ruflo-agent-repo-architect
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-repo-architect, body from .claude/agents/github/repo-architect.md). Original name: agent-repo-architect. License: MIT. Catalog: docs/incorporated-skills/README.md -->
