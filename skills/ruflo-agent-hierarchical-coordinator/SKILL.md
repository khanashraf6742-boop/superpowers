---
name: ruflo-agent-hierarchical-coordinator
description: Agent skill for hierarchical-coordinator - invoke with $ruflo-agent-hierarchical-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-hierarchical-coordinator, body from .claude/agents/swarm/hierarchical-coordinator.md). Original name: agent-hierarchical-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
