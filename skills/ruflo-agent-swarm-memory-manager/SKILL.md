---
name: ruflo-agent-swarm-memory-manager
description: Agent skill for swarm-memory-manager - invoke with $ruflo-agent-swarm-memory-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-swarm-memory-manager, body from .claude/agents/hive-mind/swarm-memory-manager.md). Original name: agent-swarm-memory-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
