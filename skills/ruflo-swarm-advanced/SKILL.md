---
name: ruflo-swarm-advanced
description: |
  Advanced swarm orchestration patterns for research, development, testing, and complex distributed workflows
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/swarm-advanced). Original name: swarm-advanced. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-sparc-methodology` - Systematic development workflow
- `github-integration` - Repository management and automation
- `neural-patterns` - AI-powered coordination optimization
- `ruflo-memory-management` - Cross-session state persistence
