...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/claims). Original name: claims. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
message *and* call `claims_claim`. See the `ruflo-cross-host-federation` skill (ruflo-bbs-federation plugin)
for the transport.
...
must be swarm-wide, keep it on the open stream. See the `ruflo-open-federation` skill for channel mechanics.
