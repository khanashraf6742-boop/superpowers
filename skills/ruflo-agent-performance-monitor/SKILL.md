---
name: ruflo-agent-performance-monitor
description: Agent skill for performance-monitor - invoke with $ruflo-agent-performance-monitor
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-performance-monitor, body from .claude/agents/optimization/performance-monitor.md). Original name: agent-performance-monitor. License: MIT. Catalog: docs/incorporated-skills/README.md -->
