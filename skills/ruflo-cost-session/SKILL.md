...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-cost-tracker/skills/cost-session). Original name: cost-session. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
| Question | Skill |
|---|---|
| "Which sessions cost the most?" | `ruflo-cost-conversation` |
| "Which sessions are outliers?" | `ruflo-cost-anomaly` |
| **"Which messages in THIS session were expensive?"** | **`ruflo-cost-session`** ← this |

## Algorithm

Implementation: [`scripts/session.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-cost-tracker/scripts/session.mjs).
