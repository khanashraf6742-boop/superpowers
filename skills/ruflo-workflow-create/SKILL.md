...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-workflows/skills/workflow-create). Original name: workflow-create. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
Run it with the `ruflo-workflow-run` skill or `Workflow({ name: 'my-workflow' })`. Reference: `.claude/workflows/plugin-contract-audit.js`. See [ADR-0002](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-workflows/docs/adrs/0002-native-workflow-orchestration.md).
