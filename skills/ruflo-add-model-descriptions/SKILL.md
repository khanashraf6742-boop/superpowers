---
name: ruflo-add-model-descriptions
description: Add descriptions for new models from the HuggingFace router to chat-ui configuration. Use when new models are released on the router and need descriptions added to prod.yaml and dev.yaml. Triggers on requests like "add new model descriptions", "update models from router", "sync models", or when explicitly invoking /ruflo-add-model-descriptions.
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, ruflo/src/ruvocal/.claude/skills/add-model-descriptions). Original name: add-model-descriptions. License: MIT. Catalog: docs/incorporated-skills/README.md -->
