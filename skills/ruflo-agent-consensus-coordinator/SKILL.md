---
name: ruflo-agent-consensus-coordinator
description: Agent skill for consensus-coordinator - invoke with $ruflo-agent-consensus-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-consensus-coordinator, body from .claude/agents/sublinear/consensus-coordinator.md). Original name: agent-consensus-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
