---
name: ruflo-agent-topology-optimizer
description: Agent skill for topology-optimizer - invoke with $ruflo-agent-topology-optimizer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-topology-optimizer, body from .claude/agents/optimization/topology-optimizer.md). Original name: agent-topology-optimizer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
