...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-cost-tracker/skills/cost-anomaly). Original name: cost-anomaly. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
| Question | Skill |
|---|---|
| "Is the AGGREGATE rate accelerating?" | `ruflo-cost-burn` |
| "Which SPECIFIC sessions are anomalous outliers?" | **`ruflo-cost-anomaly`** ← this |
| "Could we have spent less in aggregate?" | `ruflo-cost-counterfactual` |
| "When will we hit budget?" | `ruflo-cost-projection` |

## Algorithm

Implementation: [`scripts/anomaly.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-cost-tracker/scripts/anomaly.mjs).
...
Most useful when paired with `ruflo-cost-burn`:
