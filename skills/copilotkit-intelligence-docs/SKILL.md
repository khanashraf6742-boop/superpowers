---
name: copilotkit-intelligence-docs
description: >
...
<!-- Incorporated from CopilotKit/CopilotKit (fork khanashraf6742-boop/CopilotKit@ad5d77d, skills/intelligence-docs). Original name: intelligence-docs. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
`skills/copilotkit-intelligence-vocabulary/SKILL.md`.

Do not load it for open-source frontend guides that do not use Intelligence, or for
Inspector pane callouts (`copilotkit-inspector-docs`).
