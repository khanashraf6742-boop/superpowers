---
name: ruflo-agent-app-store
description: Agent skill for app-store - invoke with $ruflo-agent-app-store
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-app-store, body from .claude/agents/flow-nexus/app-store.md). Original name: agent-app-store. License: MIT. Catalog: docs/incorporated-skills/README.md -->
