---
name: ruflo-agent-safla-neural
description: Agent skill for safla-neural - invoke with $ruflo-agent-safla-neural
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-safla-neural, body from .claude/agents/neural/safla-neural.md). Original name: agent-safla-neural. License: MIT. Catalog: docs/incorporated-skills/README.md -->
