---
name: ruflo-agent-challenges
description: Agent skill for challenges - invoke with $ruflo-agent-challenges
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-challenges, body from .claude/agents/flow-nexus/challenges.md). Original name: agent-challenges. License: MIT. Catalog: docs/incorporated-skills/README.md -->
