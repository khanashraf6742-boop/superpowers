---
name: ruflo-agent-planner
description: Agent skill for planner - invoke with $ruflo-agent-planner
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-planner, body from .claude/agents/core/planner.md). Original name: agent-planner. License: MIT. Catalog: docs/incorporated-skills/README.md -->
