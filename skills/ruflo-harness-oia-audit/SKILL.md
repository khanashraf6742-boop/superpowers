...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-metaharness/skills/harness-oia-audit). Original name: harness-oia-audit. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
Implementation: [`scripts/oia-audit.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-metaharness/scripts/oia-audit.mjs).
...
A future ADR can wire this into a dedicated `ruflo-cost-diff`-style diff
viewer specifically for audit drift.

## Pairs with

- `ruflo-harness-threat-model` — the underlying threat-model component
- `ruflo-harness-mcp-scan` — the underlying MCP-scan component
- `ruflo-harness-score` + `ruflo-harness-genome` — readiness metrics (orthogonal to audit)
