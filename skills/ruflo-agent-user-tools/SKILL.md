---
name: ruflo-agent-user-tools
description: Agent skill for user-tools - invoke with $ruflo-agent-user-tools
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-user-tools, body from .claude/agents/flow-nexus/user-tools.md). Original name: agent-user-tools. License: MIT. Catalog: docs/incorporated-skills/README.md -->
