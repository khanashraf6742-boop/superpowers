---
name: ruflo-agent-workflow-automation
description: Agent skill for workflow-automation - invoke with $ruflo-agent-workflow-automation
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-workflow-automation, body from .claude/agents/github/workflow-automation.md). Original name: agent-workflow-automation. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [swarm-pr.md](../ruflo-agent-swarm-pr/SKILL.md), [swarm-issue.md](../ruflo-agent-swarm-issue/SKILL.md), [sync-coordinator.md](../ruflo-agent-sync-coordinator/SKILL.md)