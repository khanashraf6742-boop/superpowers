...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-metaharness/skills/harness-score). Original name: harness-score. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
before recommending the user run `npx ruflo init` or `ruflo-harness-mint`.

## Algorithm

Implementation: [`scripts/score.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-metaharness/scripts/score.mjs).
...
Exit 1 fails the build. Pair with `ruflo-harness-genome` for the full
7-section view.
