...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-workflows/skills/workflow-run). Original name: workflow-run. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- To author a new native workflow, use the `ruflo-workflow-create` skill.

See [ADR-0002](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-workflows/docs/adrs/0002-native-workflow-orchestration.md).
