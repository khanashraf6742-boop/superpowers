---
name: ruflo-agent-project-board-sync
description: Agent skill for project-board-sync - invoke with $ruflo-agent-project-board-sync
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-project-board-sync, body from .claude/agents/github/project-board-sync.md). Original name: agent-project-board-sync. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [swarm-issue.md](../ruflo-agent-swarm-issue/SKILL.md), [multi-repo-swarm.md](../ruflo-agent-multi-repo-swarm/SKILL.md)