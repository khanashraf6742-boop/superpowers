---
name: ruflo-agent-v3-integration-architect
description: Agent skill for v3-integration-architect - invoke with $ruflo-agent-v3-integration-architect
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-v3-integration-architect, body from .claude/agents/v3/v3-integration-architect.md). Original name: agent-v3-integration-architect. License: MIT. Catalog: docs/incorporated-skills/README.md -->
