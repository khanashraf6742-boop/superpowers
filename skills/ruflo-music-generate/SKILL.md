...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-music/skills/music-generate). Original name: music-generate. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
The user asks to create/generate/produce a song, remix, or track. If `mcp__cogmusic__create_production` isn't loaded, run `ruflo-music-connect` first.
