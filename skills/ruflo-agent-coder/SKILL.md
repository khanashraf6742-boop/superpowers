---
name: ruflo-agent-coder
description: Agent skill for coder - invoke with $ruflo-agent-coder
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-coder, body from .claude/agents/core/coder.md). Original name: agent-coder. License: MIT. Catalog: docs/incorporated-skills/README.md -->
