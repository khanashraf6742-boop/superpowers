---
name: ruflo-agent-reviewer
description: Agent skill for reviewer - invoke with $ruflo-agent-reviewer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-reviewer, body from .claude/agents/core/reviewer.md). Original name: agent-reviewer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
