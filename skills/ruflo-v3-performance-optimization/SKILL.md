---
name: ruflo-v3-performance-optimization
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/v3-performance-optimization). Original name: v3-performance-optimization. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-v3-integration-deep` - Performance integration with agentic-flow
- `ruflo-v3-memory-unification` - Memory performance optimization
- `ruflo-v3-swarm-coordination` - Swarm performance coordination
- `ruflo-v3-security-overhaul` - Secure performance patterns
