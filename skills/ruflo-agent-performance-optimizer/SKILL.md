---
name: ruflo-agent-performance-optimizer
description: Agent skill for performance-optimizer - invoke with $ruflo-agent-performance-optimizer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-performance-optimizer, body from .claude/agents/sublinear/performance-optimizer.md). Original name: agent-performance-optimizer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
