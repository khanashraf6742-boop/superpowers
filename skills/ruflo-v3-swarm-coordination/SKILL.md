---
name: ruflo-v3-swarm-coordination
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/v3-swarm-coordination). Original name: v3-swarm-coordination. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-v3-security-overhaul` - Security domain coordination
- `ruflo-v3-memory-unification` - Memory system coordination
- `ruflo-v3-integration-deep` - Integration domain coordination
- `ruflo-v3-performance-optimization` - Performance domain coordination
