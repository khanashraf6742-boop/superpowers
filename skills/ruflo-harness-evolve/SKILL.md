...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-metaharness/skills/harness-evolve). Original name: harness-evolve. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- A `ruflo-harness-score` result is below target and you don't know which policy
...
Implementation: [`scripts/evolve.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-metaharness/scripts/evolve.mjs).

1. Validate args (`--repo` exists, caps on `--generations` ≤ 50, `--children`
   ≤ 20, `--concurrency` ≤ 8, sandbox/selection/mutator are known values).
2. Without `--confirm`: print plan + exit 0 (mirrors `ruflo-harness-mint` safety
