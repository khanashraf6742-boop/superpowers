---
name: ruflo-agent-payments
description: Agent skill for payments - invoke with $ruflo-agent-payments
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-payments, body from .claude/agents/flow-nexus/payments.md). Original name: agent-payments. License: MIT. Catalog: docs/incorporated-skills/README.md -->
