---
name: ruflo-agent-matrix-optimizer
description: Agent skill for matrix-optimizer - invoke with $ruflo-agent-matrix-optimizer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-matrix-optimizer, body from .claude/agents/sublinear/matrix-optimizer.md). Original name: agent-matrix-optimizer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
