---
name: copilotkit-inspector-workbench
description: >
  ...
  copilotkit-inspector-docs), runtime or core changes with no Inspector UI, showcase
  cell work, or reading Inspector as a consumer inside an app.
version: 1.0.0
---

<!-- Incorporated from CopilotKit/CopilotKit (fork khanashraf6742-boop/CopilotKit@ad5d77d, skills/inspector-workbench). Original name: inspector-workbench. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
This skill does not replace `copilotkit-inspector-docs`. If a pane is added, renamed,
or removed, load `copilotkit-inspector-docs` as well.
...
1. If the change adds, renames, or removes a pane, load `copilotkit-inspector-docs` too.
...
- Inspector UI, chrome, overlay, launcher, or pane visuals:
  ...
  - If a pane is added, renamed, or removed: also load `copilotkit-inspector-docs`
- Docs Callout only: stop. Load `copilotkit-inspector-docs` instead.
...
| Pane added with no `copilotkit-inspector-docs` pass            | Docs Callout will drift              | Load `copilotkit-inspector-docs` in the same change              |
