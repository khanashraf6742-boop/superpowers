---
name: ruflo-agent-pagerank-analyzer
description: Agent skill for pagerank-analyzer - invoke with $ruflo-agent-pagerank-analyzer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-pagerank-analyzer, body from .claude/agents/sublinear/pagerank-analyzer.md). Original name: agent-pagerank-analyzer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
