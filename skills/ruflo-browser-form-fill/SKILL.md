...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-browser/skills/browser-form-fill). Original name: browser-form-fill. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- Multi-step forms are a sequence of `ruflo-browser-form-fill` invocations; chain them via the same session id.
