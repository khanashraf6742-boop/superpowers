---
name: ruflo-agent-code-goal-planner
description: Agent skill for code-goal-planner - invoke with $ruflo-agent-code-goal-planner
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-code-goal-planner, body from .claude/agents/goal/code-goal-planner.md). Original name: agent-code-goal-planner. License: MIT. Catalog: docs/incorporated-skills/README.md -->
