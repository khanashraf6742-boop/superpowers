---
name: copilotkit-inspector-docs
description: >
...
<!-- Incorporated from CopilotKit/CopilotKit (fork khanashraf6742-boop/CopilotKit@ad5d77d, skills/inspector-docs). Original name: inspector-docs. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
do not add a pane. Those UI changes use `copilotkit-inspector-workbench`.

If the same change also edits Inspector UI, load `copilotkit-inspector-workbench` as
