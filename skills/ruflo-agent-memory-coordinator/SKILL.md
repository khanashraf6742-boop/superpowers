---
name: ruflo-agent-memory-coordinator
description: Agent skill for memory-coordinator - invoke with $ruflo-agent-memory-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-memory-coordinator, body from .claude/agents/templates/memory-coordinator.md). Original name: agent-memory-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
