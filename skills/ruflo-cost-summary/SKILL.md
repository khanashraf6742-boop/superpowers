...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-cost-tracker/skills/cost-summary). Original name: cost-summary. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-cost-report` — narrative report (per-agent / per-model lens; uses same data)
- `ruflo-cost-export` — pushes to Prometheus / webhook (this skill is pull-style; export is push-style)
