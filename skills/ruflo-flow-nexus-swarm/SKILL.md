---
name: ruflo-flow-nexus-swarm
description: Cloud-based AI swarm deployment and event-driven workflow automation with Flow Nexus platform
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/flow-nexus-swarm). Original name: flow-nexus-swarm. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-security-audit`: Security analysis and testing
