---
name: ruflo-agent-goal-planner
description: Agent skill for goal-planner - invoke with $ruflo-agent-goal-planner
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-goal-planner, body from .claude/agents/reasoning/goal-planner.md). Original name: agent-goal-planner. License: MIT. Catalog: docs/incorporated-skills/README.md -->
