---
name: ruflo-agent-specification
description: Agent skill for specification - invoke with $ruflo-agent-specification
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-specification, body from .claude/agents/sparc/specification.md). Original name: agent-specification. License: MIT. Catalog: docs/incorporated-skills/README.md -->
