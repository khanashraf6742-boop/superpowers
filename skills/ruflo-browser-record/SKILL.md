...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-browser/skills/browser-record). Original name: browser-record. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- Establishing a reusable session that downstream skills (`ruflo-browser-extract`, `ruflo-browser-form-fill`, `ruflo-browser-test`) will compose.
...
- AIDefence gates apply at extraction time, not at navigation time. `ruflo-browser-record` is a primitive; redaction is the responsibility of skills that read content (`ruflo-browser-extract`, `ruflo-browser-test`).
