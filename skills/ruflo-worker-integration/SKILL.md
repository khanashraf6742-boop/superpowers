---
name: ruflo-worker-integration
description: Worker-Agent integration for intelligent task dispatch and performance tracking
user-invocable: true
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .claude/skills/worker-integration). Original name: worker-integration. License: MIT. Catalog: docs/incorporated-skills/README.md -->
