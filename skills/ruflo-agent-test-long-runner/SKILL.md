---
name: ruflo-agent-test-long-runner
description: Agent skill for test-long-runner - invoke with $ruflo-agent-test-long-runner
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-test-long-runner, body from .claude/agents/custom/test-long-runner.md). Original name: agent-test-long-runner. License: MIT. Catalog: docs/incorporated-skills/README.md -->
