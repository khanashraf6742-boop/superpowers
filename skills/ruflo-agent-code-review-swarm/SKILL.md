---
name: ruflo-agent-code-review-swarm
description: Agent skill for code-review-swarm - invoke with $ruflo-agent-code-review-swarm
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-code-review-swarm, body from .claude/agents/github/code-review-swarm.md). Original name: agent-code-review-swarm. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [swarm-pr.md](../ruflo-agent-swarm-pr/SKILL.md), [workflow-automation.md](../ruflo-agent-workflow-automation/SKILL.md)