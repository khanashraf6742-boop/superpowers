---
name: ruflo-verification-quality
description: |
  Comprehensive truth scoring, code quality verification, and automatic rollback system with 0.95 accuracy threshold for ensuring high-quality agent outputs and codebase reliability.
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/verification-quality). Original name: verification-quality. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
Ruflo's regression protection is three layers, all gated before publish. Authoritative reference: [`verification/README.md`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/verification/README.md).
