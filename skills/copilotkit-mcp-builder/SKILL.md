...
<!-- Incorporated from CopilotKit/CopilotKit (fork khanashraf6742-boop/CopilotKit@ad5d77d, examples/showcases/open-mcp-client/apps/mcp-use-server/.agent/skills/mcp-builder). Original name: mcp-builder. License: Apache-2.0 (mcp-use; see LICENSE.txt in the skill). Catalog: docs/incorporated-skills/README.md -->
