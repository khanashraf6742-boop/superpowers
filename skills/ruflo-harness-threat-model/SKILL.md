---
name: ruflo-harness-threat-model
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-metaharness/skills/harness-threat-model). Original name: harness-threat-model. License: MIT. Catalog: docs/incorporated-skills/README.md -->

The companion to `ruflo-harness-mcp-scan` for enterprise security reviews.
...
Implementation: [`scripts/threat-model.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-metaharness/scripts/threat-model.mjs).
