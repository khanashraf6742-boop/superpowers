---
name: ruflo-agent-swarm-issue
description: Agent skill for swarm-issue - invoke with $ruflo-agent-swarm-issue
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-swarm-issue, body from .claude/agents/github/swarm-issue.md). Original name: agent-swarm-issue. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [swarm-pr.md](../ruflo-agent-swarm-pr/SKILL.md), [sync-coordinator.md](../ruflo-agent-sync-coordinator/SKILL.md), [workflow-automation.md](../ruflo-agent-workflow-automation/SKILL.md)