---
name: ruflo-agent-authentication
description: Agent skill for authentication - invoke with $ruflo-agent-authentication
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-authentication, body from .claude/agents/flow-nexus/authentication.md). Original name: agent-authentication. License: MIT. Catalog: docs/incorporated-skills/README.md -->
