---
name: ruflo-github-multi-repo
description: |
  Multi-repository coordination, synchronization, and architecture management with AI swarm orchestration
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/github-multi-repo). Original name: github-multi-repo. License: MIT. Catalog: docs/incorporated-skills/README.md -->
