---
name: ruflo-agent-agent
description: Agent skill for agent - invoke with $ruflo-agent-agent
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-agent, body from .claude/agents/goal/agent.md). Original name: agent-agent. License: MIT. Catalog: docs/incorporated-skills/README.md -->
