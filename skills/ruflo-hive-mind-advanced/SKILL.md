---
name: ruflo-hive-mind-advanced
description: |
  Advanced Hive Mind collective intelligence system for queen-led multi-agent coordination with consensus mechanisms and persistent memory
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .claude/skills/hive-mind-advanced). Original name: hive-mind-advanced. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-swarm-orchestration`: Basic swarm coordination
- `consensus-mechanisms`: Distributed decision making
- `memory-systems`: Advanced memory management
- `ruflo-sparc-methodology`: Structured development workflow
