---
name: ruflo-agent-swarm-pr
description: Agent skill for swarm-pr - invoke with $ruflo-agent-swarm-pr
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-swarm-pr, body from .claude/agents/github/swarm-pr.md). Original name: agent-swarm-pr. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [swarm-issue.md](../ruflo-agent-swarm-issue/SKILL.md), [sync-coordinator.md](../ruflo-agent-sync-coordinator/SKILL.md), [workflow-automation.md](../ruflo-agent-workflow-automation/SKILL.md)