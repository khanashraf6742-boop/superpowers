---
name: ruflo-agent-security-manager
description: Agent skill for security-manager - invoke with $ruflo-agent-security-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-security-manager, body from .claude/agents/consensus/security-manager.md). Original name: agent-security-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
