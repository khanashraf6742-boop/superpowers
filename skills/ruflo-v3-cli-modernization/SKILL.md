---
name: ruflo-v3-cli-modernization
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/v3-cli-modernization). Original name: v3-cli-modernization. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-v3-core-implementation` - Core domain integration
- `ruflo-v3-memory-unification` - Memory-backed command caching
- `ruflo-v3-swarm-coordination` - CLI swarm management integration
- `ruflo-v3-performance-optimization` - CLI performance monitoring
