---
name: ruflo-stream-chain
description: Stream-JSON chaining for multi-agent pipelines, data transformation, and sequential workflows
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/stream-chain). Original name: stream-chain. License: MIT. Catalog: docs/incorporated-skills/README.md -->
