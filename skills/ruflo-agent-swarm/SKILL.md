---
name: ruflo-agent-swarm
description: Agent skill for swarm - invoke with $ruflo-agent-swarm
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-swarm, body from .claude/agents/flow-nexus/swarm.md). Original name: agent-swarm. License: MIT. Catalog: docs/incorporated-skills/README.md -->
