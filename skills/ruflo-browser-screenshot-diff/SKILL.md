---
name: ruflo-browser-screenshot-diff
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-browser/skills/browser-screenshot-diff). Original name: browser-screenshot-diff. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- Verifying a `ruflo-browser-replay` run matches the parent session within tolerance.
