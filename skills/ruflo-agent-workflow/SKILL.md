---
name: ruflo-agent-workflow
description: Agent skill for workflow - invoke with $ruflo-agent-workflow
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-workflow, body from .claude/agents/flow-nexus/workflow.md). Original name: agent-workflow. License: MIT. Catalog: docs/incorporated-skills/README.md -->
