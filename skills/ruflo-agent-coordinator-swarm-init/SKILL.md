---
name: ruflo-agent-coordinator-swarm-init
description: Agent skill for coordinator-swarm-init - invoke with $ruflo-agent-coordinator-swarm-init
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-coordinator-swarm-init, body from .claude/agents/templates/coordinator-swarm-init.md). Original name: agent-coordinator-swarm-init. License: MIT. Catalog: docs/incorporated-skills/README.md -->
