---
name: ruflo-agent-multi-repo-swarm
description: Agent skill for multi-repo-swarm - invoke with $ruflo-agent-multi-repo-swarm
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-multi-repo-swarm, body from .claude/agents/github/multi-repo-swarm.md). Original name: agent-multi-repo-swarm. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [swarm-pr.md](../ruflo-agent-swarm-pr/SKILL.md), [project-board-sync.md](../ruflo-agent-project-board-sync/SKILL.md)