---
name: ruflo-agent-researcher
description: Agent skill for researcher - invoke with $ruflo-agent-researcher
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-researcher, body from .claude/agents/core/researcher.md). Original name: agent-researcher. License: MIT. Catalog: docs/incorporated-skills/README.md -->
