...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-goals/skills/dossier-collect). Original name: dossier-collect. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
For specific questions use `ruflo-deep-research`. For multi-step plans use `ruflo-goal-plan`.
...
```
/ruflo-dossier-collect ruvnet
/ruflo-dossier-collect ADR-097 --max-depth 1
/ruflo-dossier-collect "src/memory/hnsw.ts" --sources codebase,git,memory
/ruflo-dossier-collect "ruflo-goals" --max-breadth 5 --budget-usd 1
```
