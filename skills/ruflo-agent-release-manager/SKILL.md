---
name: ruflo-agent-release-manager
description: Agent skill for release-manager - invoke with $ruflo-agent-release-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-release-manager, body from .claude/agents/github/release-manager.md). Original name: agent-release-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
