---
name: ruflo-cost-compact-context
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-cost-tracker/skills/cost-compact-context). Original name: cost-compact-context. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
Booster-specific availability is **not** exposed as a getter — observable only through `optimizedEdit()` returning `method: 'agent-booster'`. The canonical Tier 1 signal is `[AGENT_BOOSTER_AVAILABLE]` (see `ruflo-cost-booster-route`).
