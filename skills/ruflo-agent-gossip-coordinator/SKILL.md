---
name: ruflo-agent-gossip-coordinator
description: Agent skill for gossip-coordinator - invoke with $ruflo-agent-gossip-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-gossip-coordinator, body from .claude/agents/consensus/gossip-coordinator.md). Original name: agent-gossip-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
