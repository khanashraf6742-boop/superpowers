---
name: ruflo-agent-issue-tracker
description: Agent skill for issue-tracker - invoke with $ruflo-agent-issue-tracker
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-issue-tracker, body from .claude/agents/github/issue-tracker.md). Original name: agent-issue-tracker. License: MIT. Catalog: docs/incorporated-skills/README.md -->
