---
name: ruflo-v3-mcp-optimization
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/v3-mcp-optimization). Original name: v3-mcp-optimization. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-v3-core-implementation` - Core domain integration with MCP
- `ruflo-v3-performance-optimization` - Overall performance optimization
- `ruflo-v3-swarm-coordination` - MCP integration with swarm coordination
- `ruflo-v3-memory-unification` - Memory sharing via MCP tools
