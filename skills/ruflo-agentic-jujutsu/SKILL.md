---
name: ruflo-agentic-jujutsu
description: |
  Quantum-resistant, self-learning version control for AI agents with ReasoningBank intelligence and multi-agent coordination
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .claude/skills/agentic-jujutsu). Original name: agentic-jujutsu. License: MIT. Catalog: docs/incorporated-skills/README.md -->
