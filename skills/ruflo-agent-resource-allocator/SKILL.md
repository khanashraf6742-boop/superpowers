---
name: ruflo-agent-resource-allocator
description: Agent skill for resource-allocator - invoke with $ruflo-agent-resource-allocator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-resource-allocator, body from .claude/agents/optimization/resource-allocator.md). Original name: agent-resource-allocator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
