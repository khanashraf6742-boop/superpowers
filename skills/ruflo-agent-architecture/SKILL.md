---
name: ruflo-agent-architecture
description: Agent skill for architecture - invoke with $ruflo-agent-architecture
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-architecture, body from .claude/agents/sparc/architecture.md). Original name: agent-architecture. License: MIT. Catalog: docs/incorporated-skills/README.md -->
