...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-metaharness/skills/harness-genome). Original name: harness-genome. License: MIT. Catalog: docs/incorporated-skills/README.md -->

Companion to `ruflo-harness-score`. Where score is a 5-dimension numeric
...
Implementation: [`scripts/genome.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-metaharness/scripts/genome.mjs).
...
- `ruflo-harness-score` — numeric readiness
- `ruflo-harness-mcp-scan` — static MCP security findings
- `ruflo-harness-threat-model` — enterprise-review-grade threat model
