---
name: ruflo-agent-mesh-coordinator
description: Agent skill for mesh-coordinator - invoke with $ruflo-agent-mesh-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-mesh-coordinator, body from .claude/agents/swarm/mesh-coordinator.md). Original name: agent-mesh-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
