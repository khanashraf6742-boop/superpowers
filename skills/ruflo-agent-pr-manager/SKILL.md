---
name: ruflo-agent-pr-manager
description: Agent skill for pr-manager - invoke with $ruflo-agent-pr-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-pr-manager, body from .claude/agents/github/pr-manager.md). Original name: agent-pr-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
