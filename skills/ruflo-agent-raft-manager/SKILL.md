---
name: ruflo-agent-raft-manager
description: Agent skill for raft-manager - invoke with $ruflo-agent-raft-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-raft-manager, body from .claude/agents/consensus/raft-manager.md). Original name: agent-raft-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
