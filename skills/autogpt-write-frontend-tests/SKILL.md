---
name: autogpt-write-frontend-tests
...
<!-- Incorporated from Significant-Gravitas/AutoGPT (fork khanashraf6742-boop/AutoGPT@45275cb, .claude/skills/write-frontend-tests). Original name: write-frontend-tests. License: MIT. Catalog: docs/incorporated-skills/README.md -->
