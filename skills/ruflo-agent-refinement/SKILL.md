---
name: ruflo-agent-refinement
description: Agent skill for refinement - invoke with $ruflo-agent-refinement
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-refinement, body from .claude/agents/sparc/refinement.md). Original name: agent-refinement. License: MIT. Catalog: docs/incorporated-skills/README.md -->
