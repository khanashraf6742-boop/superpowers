---
name: ruflo-dual-collect
description: Collect results from headless Codex workers
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/dual-mode/dual-collect.md). Original name: dual-collect. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
```
/ruflo-dual-collect [--namespace <namespace>] [--format <format>]
```
...
```
/ruflo-dual-collect --namespace patterns
```

### Detailed Output
```
/ruflo-dual-collect --format detailed
```

### Filter by Worker
```
/ruflo-dual-collect --filter "worker-auth-*"
```
...
- `/ruflo-dual-spawn` - Spawn headless workers
- `/ruflo-dual-coordinate` - Full hybrid workflow
