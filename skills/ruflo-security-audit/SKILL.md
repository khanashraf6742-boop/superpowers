...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/security-audit). Original name: security-audit. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
|--------|------|-------------|
| `security-scan` | `scripts/security-scan.sh` | Run full security scan pipeline |
| `cve-remediate` | `scripts/cve-remediate.sh` | Auto-remediate known CVEs |
