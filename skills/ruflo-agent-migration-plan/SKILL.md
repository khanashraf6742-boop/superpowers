---
name: ruflo-agent-migration-plan
description: Agent skill for migration-plan - invoke with $ruflo-agent-migration-plan
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-migration-plan, body from .claude/agents/templates/migration-plan.md). Original name: agent-migration-plan. License: MIT. Catalog: docs/incorporated-skills/README.md -->
