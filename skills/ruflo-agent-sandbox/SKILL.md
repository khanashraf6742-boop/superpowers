---
name: ruflo-agent-sandbox
description: Agent skill for sandbox - invoke with $ruflo-agent-sandbox
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-sandbox, body from .claude/agents/flow-nexus/sandbox.md). Original name: agent-sandbox. License: MIT. Catalog: docs/incorporated-skills/README.md -->
