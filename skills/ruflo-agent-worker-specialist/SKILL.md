---
name: ruflo-agent-worker-specialist
description: Agent skill for worker-specialist - invoke with $ruflo-agent-worker-specialist
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-worker-specialist, body from .claude/agents/hive-mind/worker-specialist.md). Original name: agent-worker-specialist. License: MIT. Catalog: docs/incorporated-skills/README.md -->
