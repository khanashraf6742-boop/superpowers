---
name: ruflo-agent-adaptive-coordinator
description: Agent skill for adaptive-coordinator - invoke with $ruflo-agent-adaptive-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-adaptive-coordinator, body from .claude/agents/swarm/adaptive-coordinator.md). Original name: agent-adaptive-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
