---
name: ruflo-agent-performance-benchmarker
description: Agent skill for performance-benchmarker - invoke with $ruflo-agent-performance-benchmarker
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-performance-benchmarker, body from .claude/agents/consensus/performance-benchmarker.md). Original name: agent-performance-benchmarker. License: MIT. Catalog: docs/incorporated-skills/README.md -->
