...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-testgen/skills/tdd-repair). Original name: tdd-repair. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- Local TDD workflow — write the failing test first (`ruflo-tdd-workflow` skill), then run `ruflo-tdd-repair` to drive the green.
...
Implementation: [`scripts/tdd-repair/tdd-repair.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-testgen/scripts/tdd-repair/tdd-repair.mjs).
...
| Confirmation gate | `--confirm` REQUIRED — without it, returns dry-run plan (mirrors `ruflo-harness-evolve` / `ruflo-harness-mint` convention). |
