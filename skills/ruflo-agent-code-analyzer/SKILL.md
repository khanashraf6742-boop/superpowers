---
name: ruflo-agent-code-analyzer
description: Agent skill for code-analyzer - invoke with $ruflo-agent-code-analyzer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-code-analyzer, body from .claude/agents/analysis/code-analyzer.md). Original name: agent-code-analyzer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
