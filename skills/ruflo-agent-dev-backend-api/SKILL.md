---
name: ruflo-agent-dev-backend-api
description: Agent skill for dev-backend-api - invoke with $ruflo-agent-dev-backend-api
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-dev-backend-api, body from .claude/agents/development/dev-backend-api.md). Original name: agent-dev-backend-api. License: MIT. Catalog: docs/incorporated-skills/README.md -->
