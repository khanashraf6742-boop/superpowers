---
name: ruflo-agent-sync-coordinator
description: Agent skill for sync-coordinator - invoke with $ruflo-agent-sync-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-sync-coordinator, body from .claude/agents/github/sync-coordinator.md). Original name: agent-sync-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
