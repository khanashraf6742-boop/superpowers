---
name: ruflo-agent-release-swarm
description: Agent skill for release-swarm - invoke with $ruflo-agent-release-swarm
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-release-swarm, body from .claude/agents/github/release-swarm.md). Original name: agent-release-swarm. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
See also: [workflow-automation.md](../ruflo-agent-workflow-automation/SKILL.md), [multi-repo-swarm.md](../ruflo-agent-multi-repo-swarm/SKILL.md)