---
name: ruflo-agent-neural-network
description: Agent skill for neural-network - invoke with $ruflo-agent-neural-network
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-neural-network, body from .claude/agents/flow-nexus/neural-network.md). Original name: agent-neural-network. License: MIT. Catalog: docs/incorporated-skills/README.md -->
