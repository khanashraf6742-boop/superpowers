---
name: ruflo-agent-performance-analyzer
description: Agent skill for performance-analyzer - invoke with $ruflo-agent-performance-analyzer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-performance-analyzer, body from .claude/agents/templates/performance-analyzer.md). Original name: agent-performance-analyzer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
