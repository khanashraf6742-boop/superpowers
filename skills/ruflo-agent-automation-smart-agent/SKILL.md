---
name: ruflo-agent-automation-smart-agent
description: Agent skill for automation-smart-agent - invoke with $ruflo-agent-automation-smart-agent
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-automation-smart-agent, body from .claude/agents/templates/automation-smart-agent.md). Original name: agent-automation-smart-agent. License: MIT. Catalog: docs/incorporated-skills/README.md -->
