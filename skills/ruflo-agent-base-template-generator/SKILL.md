---
name: ruflo-agent-base-template-generator
description: Agent skill for base-template-generator - invoke with $ruflo-agent-base-template-generator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-base-template-generator, body from .claude/agents/base-template-generator.md). Original name: agent-base-template-generator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
