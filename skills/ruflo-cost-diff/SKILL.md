...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-cost-tracker/skills/cost-diff). Original name: cost-diff. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
| Question | Skill |
|---|---|
| "What would we have spent at always-X?" | `ruflo-cost-counterfactual` |
| "Is daily burn accelerating vs prior mean?" | `ruflo-cost-burn` |
| "Did THIS PR add spend vs main?" | **`ruflo-cost-diff`** ← this |

## Algorithm

Implementation: [`scripts/diff.mjs`](https://github.com/ruvnet/ruflo/blob/025842bb0f860a908b286846c701e156c7f3f739/plugins/ruflo-cost-tracker/scripts/diff.mjs). Consumes the
...
same shape works — `ruflo-cost-diff` is just one consumer.
