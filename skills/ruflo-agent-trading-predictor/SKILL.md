---
name: ruflo-agent-trading-predictor
description: Agent skill for trading-predictor - invoke with $ruflo-agent-trading-predictor
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-trading-predictor, body from .claude/agents/sublinear/trading-predictor.md). Original name: agent-trading-predictor. License: MIT. Catalog: docs/incorporated-skills/README.md -->
