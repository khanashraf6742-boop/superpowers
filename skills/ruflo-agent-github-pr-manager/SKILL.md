---
name: ruflo-agent-github-pr-manager
description: Agent skill for github-pr-manager - invoke with $ruflo-agent-github-pr-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-github-pr-manager, body from .claude/agents/templates/github-pr-manager.md). Original name: agent-github-pr-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
