---
name: ruflo-agent-tdd-london-swarm
description: Agent skill for tdd-london-swarm - invoke with $ruflo-agent-tdd-london-swarm
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-tdd-london-swarm, body from .claude/agents/testing/tdd-london-swarm.md). Original name: agent-tdd-london-swarm. License: MIT. Catalog: docs/incorporated-skills/README.md -->
