...
description: >
  ...
  the first time is not: if no Slack app exists yet, use copilotkit-setup-slack-channel for
  the provider half and return here for the code.
version: 1.1.0
---

<!-- Incorporated from CopilotKit/CopilotKit (fork khanashraf6742-boop/CopilotKit@ad5d77d, skills/copilotkit-channels). License: MIT. Catalog: docs/incorporated-skills/README.md -->
