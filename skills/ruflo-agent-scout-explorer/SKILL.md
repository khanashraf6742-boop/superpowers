---
name: ruflo-agent-scout-explorer
description: Agent skill for scout-explorer - invoke with $ruflo-agent-scout-explorer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-scout-explorer, body from .claude/agents/hive-mind/scout-explorer.md). Original name: agent-scout-explorer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
