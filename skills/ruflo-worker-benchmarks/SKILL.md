---
name: ruflo-worker-benchmarks
description: Run comprehensive worker system benchmarks and performance analysis
user-invocable: true
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .claude/skills/worker-benchmarks). Original name: worker-benchmarks. License: MIT. Catalog: docs/incorporated-skills/README.md -->
