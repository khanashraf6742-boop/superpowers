---
name: ruflo-agent-agentic-payments
description: Agent skill for agentic-payments - invoke with $ruflo-agent-agentic-payments
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-agentic-payments, body from .claude/agents/payments/agentic-payments.md). Original name: agent-agentic-payments. License: MIT. Catalog: docs/incorporated-skills/README.md -->
