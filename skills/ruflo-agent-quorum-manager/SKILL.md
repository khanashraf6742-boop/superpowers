---
name: ruflo-agent-quorum-manager
description: Agent skill for quorum-manager - invoke with $ruflo-agent-quorum-manager
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-quorum-manager, body from .claude/agents/consensus/quorum-manager.md). Original name: agent-quorum-manager. License: MIT. Catalog: docs/incorporated-skills/README.md -->
