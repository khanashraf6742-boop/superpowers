---
name: ruflo-sparc-methodology
description: |
  SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) comprehensive development methodology with multi-agent orchestration
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/sparc-methodology). Original name: sparc-methodology. License: MIT. Catalog: docs/incorporated-skills/README.md -->
