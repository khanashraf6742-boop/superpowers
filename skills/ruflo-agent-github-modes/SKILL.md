---
name: ruflo-agent-github-modes
description: Agent skill for github-modes - invoke with $ruflo-agent-github-modes
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-github-modes, body from .claude/agents/github/github-modes.md). Original name: agent-github-modes. License: MIT. Catalog: docs/incorporated-skills/README.md -->
