---
name: ruflo-agent-crdt-synchronizer
description: Agent skill for crdt-synchronizer - invoke with $ruflo-agent-crdt-synchronizer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-crdt-synchronizer, body from .claude/agents/consensus/crdt-synchronizer.md). Original name: agent-crdt-synchronizer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
