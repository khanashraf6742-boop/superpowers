---
name: ruflo-agent-v3-security-architect
description: Agent skill for v3-security-architect - invoke with $ruflo-agent-v3-security-architect
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-v3-security-architect, body from .claude/agents/v3/v3-security-architect.md). Original name: agent-v3-security-architect. License: MIT. Catalog: docs/incorporated-skills/README.md -->
