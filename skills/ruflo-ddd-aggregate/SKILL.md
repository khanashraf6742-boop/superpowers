...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-ddd/skills/ddd-aggregate). Original name: ddd-aggregate. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
1. **Validate**: Confirm `src/<context>/domain/` exists. If not, suggest running `/ruflo-ddd-context <context>` first.
