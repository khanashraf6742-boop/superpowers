---
name: ruflo-agent-implementer-sparc-coder
description: Agent skill for implementer-sparc-coder - invoke with $ruflo-agent-implementer-sparc-coder
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-implementer-sparc-coder, body from .claude/agents/templates/implementer-sparc-coder.md). Original name: agent-implementer-sparc-coder. License: MIT. Catalog: docs/incorporated-skills/README.md -->
