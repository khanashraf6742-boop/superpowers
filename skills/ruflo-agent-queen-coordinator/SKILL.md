---
name: ruflo-agent-queen-coordinator
description: Agent skill for queen-coordinator - invoke with $ruflo-agent-queen-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-queen-coordinator, body from .claude/agents/hive-mind/queen-coordinator.md). Original name: agent-queen-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
