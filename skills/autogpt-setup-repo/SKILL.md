...
<!-- Incorporated from Significant-Gravitas/AutoGPT (fork khanashraf6742-boop/AutoGPT@45275cb, .claude/skills/setup-repo). Original name: setup-repo. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
Env file locations to check (same as the `/autogpt-worktree` skill — keep these in sync):
- `autogpt_platform/.env`
- `autogpt_platform/backend/.env`
- `autogpt_platform/frontend/.env`

> **Note:** This env copying logic intentionally mirrors the `/autogpt-worktree` skill's approach. If you update the path list or fallback logic here, update `/autogpt-worktree` as well.
