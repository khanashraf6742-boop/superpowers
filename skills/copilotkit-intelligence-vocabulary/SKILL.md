---
name: copilotkit-intelligence-vocabulary
description: >
...
<!-- Incorporated from CopilotKit/CopilotKit (fork khanashraf6742-boop/CopilotKit@ad5d77d, skills/intelligence-vocabulary). Original name: intelligence-vocabulary. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
Also load `skills/copilotkit-intelligence-docs/SKILL.md` when the change adds, renames, or removes an Intelligence page. That skill keeps the landing page in sync. This skill owns the words.
...
- Page added, renamed, or removed: this skill for the words, and `skills/copilotkit-intelligence-docs/SKILL.md` for the landing page
