---
name: ruflo-agent-orchestrator-task
description: Agent skill for orchestrator-task - invoke with $ruflo-agent-orchestrator-task
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-orchestrator-task, body from .claude/agents/templates/orchestrator-task.md). Original name: agent-orchestrator-task. License: MIT. Catalog: docs/incorporated-skills/README.md -->
