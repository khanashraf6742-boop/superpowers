---
name: ruflo-flow-nexus-neural
description: Train and deploy neural networks in distributed E2B sandboxes with Flow Nexus
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, v3/@claude-flow/cli/.claude/skills/flow-nexus-neural). Original name: flow-nexus-neural. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- `ruflo-flow-nexus-swarm` - AI swarm orchestration
