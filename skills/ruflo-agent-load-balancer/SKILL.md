---
name: ruflo-agent-load-balancer
description: Agent skill for load-balancer - invoke with $ruflo-agent-load-balancer
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-load-balancer, body from .claude/agents/optimization/load-balancer.md). Original name: agent-load-balancer. License: MIT. Catalog: docs/incorporated-skills/README.md -->
