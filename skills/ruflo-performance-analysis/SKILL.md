---
name: ruflo-performance-analysis
description: |
  Comprehensive performance analysis, bottleneck detection, and optimization recommendations for Claude Flow swarms
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .claude/skills/performance-analysis). Original name: performance-analysis. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
- [Swarm Monitoring Documentation](../ruflo-swarm-orchestration/SKILL.md)
- [Memory Management Documentation](../ruflo-memory-management/SKILL.md)
