---
name: ruflo-agent-pseudocode
description: Agent skill for pseudocode - invoke with $ruflo-agent-pseudocode
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-pseudocode, body from .claude/agents/sparc/pseudocode.md). Original name: agent-pseudocode. License: MIT. Catalog: docs/incorporated-skills/README.md -->
