...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/memory-management). Original name: memory-management. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
|--------|------|-------------|
| `memory-backup` | `scripts/memory-backup.sh` | Backup memory to external storage |
| `memory-consolidate` | `scripts/memory-consolidate.sh` | Consolidate and optimize memory |
