---
name: ruflo-agent-sparc-coordinator
description: Agent skill for sparc-coordinator - invoke with $ruflo-agent-sparc-coordinator
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-sparc-coordinator, body from .claude/agents/templates/sparc-coordinator.md). Original name: agent-sparc-coordinator. License: MIT. Catalog: docs/incorporated-skills/README.md -->
