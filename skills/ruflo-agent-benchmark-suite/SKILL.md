---
name: ruflo-agent-benchmark-suite
description: Agent skill for benchmark-suite - invoke with $ruflo-agent-benchmark-suite
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-benchmark-suite, body from .claude/agents/optimization/benchmark-suite.md). Original name: agent-benchmark-suite. License: MIT. Catalog: docs/incorporated-skills/README.md -->
