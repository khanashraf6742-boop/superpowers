---
name: ruflo-agent-tester
description: Agent skill for tester - invoke with $ruflo-agent-tester
---

<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, .agents/skills/agent-tester, body from .claude/agents/core/tester.md). Original name: agent-tester. License: MIT. Catalog: docs/incorporated-skills/README.md -->
