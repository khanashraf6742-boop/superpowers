...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-browser/skills/browser-test). Original name: browser-test. License: MIT. Catalog: docs/incorporated-skills/README.md -->
...
1. **Record the test run** by composing `ruflo-browser-record`:
...
8. **(Optional) Diff against `--against <prior-session-id>`**: invoke `ruflo-browser-screenshot-diff` to compare the new run with a baseline.
