---
name: ruflo-cost-counterfactual
...
<!-- Incorporated from ruvnet/ruflo (fork khanashraf6742-boop/ruflo@025842b, plugins/ruflo-cost-tracker/skills/cost-counterfactual). Original name: cost-counterfactual. License: MIT. Catalog: docs/incorporated-skills/README.md -->

Multi-baseline counterfactual cost analysis. Pairs with the existing observability surface:

- **`ruflo-cost-budget-check`** — "have we crossed a threshold?" (reactive)
- **`ruflo-cost-projection`** — "when will we cross a threshold?" (predictive)
- **`ruflo-cost-counterfactual`** — "is the routing earning its keep?" (comparative) ← this one
